...
export default function Home() {
  return (
    <div className="bg-cover bg-[url('../../starter-code/assets/home/background-home-mobile.jpg')] md:bg-[url('../../starter-code/assets/home/background-home-tablet.jpg')] lg:bg-[url('../../starter-code/assets/home/background-home-desktop.jpg')] h-full grid lg:grid-rows-1 lg:grid-cols-2 justify-items-center items-center gap-8 grid-rows-2 grid-cols-1 justify-around mt-10 text-white">
