...
export default async function Page(props: { children: React.ReactNode }) {
  ...
  return (
    <div className="h-full justify-center gap-10 pt-32 pb-16 flex flex-col bg-cover bg-[url('/assets/destination/background-destination-mobile.jpg')] md:bg-[url('/assets/destination/background-destination-tablet.jpg')] lg:bg-[url('/assets/destination/background-destination-desktop.jpg')]">
